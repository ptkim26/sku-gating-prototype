...
const AhaInlineSuggestionDemo: React.FC = () => {
      ...
      <ContentWrapper>
        ...
        <GroupBuilderBase
          renderSuggestion={({ selectedIds, rules, onAcceptRule }) => {
            ...
            const suggestionText = clusterToSuggestionText(top);
            ...
            return (
              <SuggestionBar>
                ...
                <SuggestionText>
                  {suggestionText}. Use a <strong>{top.attributeLabel}</strong> rule instead?
                </SuggestionText>
                <SuggestionActions>
                  <Button
                    size={Button.SIZES.S}
...
export default AhaInlineSuggestionDemo;
