...
const AhaEmptyStateDemo: React.FC = () => {
    ...
    <PageContainer>
      <ContentWrapper>
        ...
        <DemoHeader>
          ...
          <DemoSubtitle>
            Before you start typing names, the builder suggests rules based on
            your org data. Click a suggestion to add it as a dynamic rule, or
            start typing to search for people manually.
          </DemoSubtitle>
        </DemoHeader>
              ...
              <SuggestionPills>
                {ORG_SUGGESTIONS.map((s) => {
                  const rule: RuleItem = {
                    ...
                    label: `${s.attribute === 'department' ? 'Department' : s.attribute === 'location' ? 'Location' : 'Employment Type'}: ${s.value}`,
...
export default AhaEmptyStateDemo;
