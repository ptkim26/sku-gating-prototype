...
| Token | Value | Usage |
|-------|-------|-------|
| `shapeCornerS` | 4px | Small elements (badges) |
| `shapeCornerM` | 8px | Standard elements (buttons, inputs) |
| `shapeCornerL` | 12px | Large elements (cards) |
| `shapeCornerXL` | 16px | Extra large elements (modals) |
